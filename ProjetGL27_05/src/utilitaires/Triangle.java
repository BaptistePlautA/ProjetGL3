...
class Triangle {
    ...
    public List<Arete> arretes() {
        List<Arete> arretes = new ArrayList<>();
        arretes.add(new Arete(p0, p1));
        arretes.add(new Arete(p1, p2));
        arretes.add(new Arete(p2, p0));
        return arretes;
    }
